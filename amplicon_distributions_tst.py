...
INTERVALS_BED_A = '/home/benflies/NGS_Data/TST_15-A-manifest.bed'
INTERVALS_BED_B = '/home/benflies/NGS_Data/TST_15-B-manifest.bed'

COVERAGE_THRESHOLD = 1000

directory_A = '/home/benflies/NGS_Data/BAM/bam_tst/miseq_reporter/mixA'
directory_B = '/home/benflies/NGS_Data/BAM/bam_tst/miseq_reporter/mixB'
...
bam_file_list_B = [f for f in glob.iglob(directory_B+"/*.bam")]

for file in bam_file_list_B:
    ...
    if INTERVALS_BED_B:
        with open(INTERVALS_BED_B, "r") as fin:
            for line in fin.readlines():
                line = line.rstrip('\n')
                line = re.split(r'\t+', line.rstrip('\t'))
